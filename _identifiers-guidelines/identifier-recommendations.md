...
| [schema:Place](https://schema.org/Place)<br>[schema:CreativeWork](https://schema.org/CreativeWork)<br>[ado:LivePerformanceWork](http://kg.artsdata.ca/ontology/LivePerformanceWork) | <span style="color:green">**Recommended**</span> | <span style="color:green">**Recommended**</span> | Not a valid type for this ID | Optional |
