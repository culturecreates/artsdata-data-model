...
- L’incertitude quant à la notoriété ou aux conventions de dénomination.
...
Lorsque plusieurs interprètes sont pertinents (par exemple, une tête d’affiche et une première partie), utilisez [`Role`](https://schema.org/Role) afin de préciser leurs rôles respectifs.
