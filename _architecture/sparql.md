...
The default SPARQL endpoint is: https://query.artsdata.ca/sparql. This endpoint only queries the Artsdata core graph. 

To query across all data feeds and core graphs you can use this other SPARQL endpoint: https://db.artsdata.ca/repositories/artsdata
