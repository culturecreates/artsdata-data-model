...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<ostruct>.freeze, ["~> 0.6".freeze])
  s.add_development_dependency(%q<rack-test>.freeze, ["~> 2.2".freeze])
  s.add_development_dependency(%q<rack>.freeze, ["~> 3.1".freeze])
  s.add_development_dependency(%q<rackup>.freeze, ["~> 2.2".freeze])
  ...
  s.add_development_dependency(%q<sinatra>.freeze, ["~> 4.1".freeze])
  s.add_development_dependency(%q<webrick>.freeze, ["~> 1.9".freeze])
